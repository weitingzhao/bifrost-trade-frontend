...
When designing or refactoring Bifrost Trade UI, combine this Skill's general guidance with the project rules in `.cursor/rules/monitoring-ui.mdc` (monitoring/IB account layout, traffic lights, self-check), and treat Skote as a "reference atlas" rather than a template project.
