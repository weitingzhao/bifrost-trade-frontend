...
/**
 * Which messages interrupt, and which just wait in Alerts.
 *
 ...
 * looking, and Alerts is where facts wait.
 *
 ...
 * Alerts. The second clause needs a channel to recognise "you triggered
