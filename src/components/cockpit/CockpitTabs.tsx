...
import { CopilotTab } from '@/components/cockpit/CopilotTab'
...
const TAB_TRIGGER =
  'h-7 px-2 text-dense-meta data-active:shadow-sm'
...
export function CockpitTabs({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <TabsContent value="copilot" className="mt-0 flex min-h-0 flex-1 flex-col overflow-hidden pr-1">
        <CopilotTab />
      </TabsContent>
