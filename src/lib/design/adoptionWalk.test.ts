...
// this one is the history the counts are pinned to. Its revision half is
// `adoptionWalkRev.test.ts` (split 2026-09-25 at the same line).
describe('the design walk, as it stands', () => {
  it('reads the walk as it stands', () => {
    ...
    expect(counts.byState.backlog).toBe(0)
  })
})
