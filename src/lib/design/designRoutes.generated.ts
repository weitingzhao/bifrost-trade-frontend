...
export const DESIGN_GLYPHS: Readonly<Record<string, string>> = {
  ...
  "conform": "M4 7l2 2 4-4M4 15l2 2 4-4M14 8h6M14 16h6",
  ...
  "lanes": "M4 4h4v16H4zM10 4h4v11h-4zM16 4h4v7h-4z",
  "layers": "M12 3l9 5-9 5-9-5 9-5zM3 14l9 5 9-5",
  "lens": "M11 4a7 7 0 100 14 7 7 0 000-14M16.2 16.2L20.5 20.5",
  "loop": "M5 12a7 7 0 0111-5.7M19 12a7 7 0 01-11 5.7M16 3.5V7h-3.5M8 20.5V17h3.5",
  ...
  "pipe": "M3 12h4M7 9h4v6H7zM11 12h2M13 8h4v8h-4zM17 12h4",
  ...
  "stamp": "M8 13h8v3H8zM6 17h12v3H6zM10 13V9a2 2 0 114 0v4",
  ...
  "tape": "M3 12h3l2-5 3 10 3-7 2 4 2-2h3",
  "today": "M3 19h18M6 15a6 6 0 0112 0M12 6V3M4.6 8.6l1.8 1.8M19.4 8.6l-1.8 1.8",
  "tray": "M3 13h5l2 3h4l2-3h5M5 5h14l2 8v6H3v-6z",
...
export const DESIGN_ROUTE_GLYPH: Readonly<Record<string, string>> = {
  ...
  "/docs/research-calibration": "sliders",
  "/docs/research-menu": "sidebar",
  "/docs/research-vision": "bubble",
